...
<?php
  ...
  if (isset($_POST["Submit"])) {
    ...
    if (empty($UserName)||empty($Password)) {
      ...
      $Found_Account = User_Login_Attempt($UserName,$Password);   
      if($Found_Account) {
          ...
          <div class="col-6 offset-3">
            <div class=" justify-content-center align-items-center" style="padding-top:25vh" >
              ...
              <form class="shadow p-3 text-black"
                  ...
                  <h4 class="display-6 ">User Login</h4><br>
                  ...
                  <a href="UserRegistration.php" class="link-secondary" style="text-decoration:none; font-size: 17px; padding-left:5px">Register</a>
